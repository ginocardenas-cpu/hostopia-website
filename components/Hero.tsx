...
export default function Hero() {
  return (
    <section className="relative flex flex-col justify-center overflow-hidden pt-20" style={{ backgroundColor: "#f7f6f2" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Right: Hero image — displayed at natural proportions, never stretched */}
          <div className="flex items-center justify-center lg:justify-end">
            <Image
              ...
              height={600}
              priority
              className="w-full h-auto max-w-xl lg:max-w-none"
